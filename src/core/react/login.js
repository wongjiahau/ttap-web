...
const parseStudentHtmlToRawSlot_v2_1 = require("../parser/parseStudentHtmlToRawSlot_v2");
...
const ParseStudentHtmlToRawSlot = (() => {
    ...
    if (currentYear > 2019) {
        ...
        return parseStudentHtmlToRawSlot_v2_1.default;
    }
    else {
        console.log('Using ParseStudentHtmlToRawSlot_v1');
        return parseStudentHtmlToRawSlot_1.default;
    }
})();
const divStyle = {
    textAlign: "center",
