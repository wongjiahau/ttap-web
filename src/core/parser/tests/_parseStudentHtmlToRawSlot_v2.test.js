...
const fs = require("fs");
const parseStudentHtmlToRawSlot_v2_1 = require("../parseStudentHtmlToRawSlot_v2");
...
describe("ParseStudentHtmlToRawSlot_v2", () => {
    ...
    const rawSlots = parseStudentHtmlToRawSlot_v2_1.default(html);
    ...
    it("case 3", () => {
        ...
        chai_1.expect(rawSlots).to.have.lengthOf(maxSlotNumber + numberOfSubSlots);
    });
});
//# sourceMappingURL=_parseStudentHtmlToRawSlot_v2.test.js.map