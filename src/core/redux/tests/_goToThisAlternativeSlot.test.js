...
describe("showAlternateSlot action", () => {
    it("should set alternate slots based on clicked slot", () => {
        ...
        chai_1.expect(newState2.TimetableListState.CurrentSubIndex).to.eq(0);
        const newState3 = masterState_1.MasterStateReducer(newState2, new goToThisAlternativeSlot_1.GoToThisAlternativeSlot(slotsToBeClicked.Uid, newState2.TimetableListState.ShowingAlternateSlotOf
            ? newState2.TimetableListState.ShowingAlternateSlotOf.AlternativeSlots[1].slot.Uid
            : -1));
    ...
    it("case 2", () => {
        ...
        const newState4 = masterState_1.MasterStateReducer(newState3, new goToThisAlternativeSlot_1.GoToThisAlternativeSlot(slotsToBeClicked.Uid, newState3.TimetableListState.ShowingAlternateSlotOf
            ? newState3.TimetableListState.ShowingAlternateSlotOf.AlternativeSlots[0].slot.Uid
            : -1));
    ...
    it("case 3", () => {
        ...
        const newState3 = masterState_1.MasterStateReducer(newState2, new showAlternateSlot_1.ShowAlternateSlot(slotsToBeClicked));
        const newState4 = masterState_1.MasterStateReducer(newState3, new goToThisAlternativeSlot_1.GoToThisAlternativeSlot(slotsToBeClicked.Uid, 
        ...
        newState3.TimetableListState.ShowingAlternateSlotOf
            ? newState3.TimetableListState.ShowingAlternateSlotOf.AlternativeSlots
                .filter((x) => x.slot.Group[0] === "28")[0].slot.Uid
            : -1));
        ...
        const slotsToBeClicked2 = newState5.TimetableListState.SlotViewModelStore.GetAll()
            .filter((x) => x.SubjectCode === "UEME2123" &&
            x.Type === "P" &&
        ...
        const newState7 = masterState_1.MasterStateReducer(newState6, new goToThisAlternativeSlot_1.GoToThisAlternativeSlot(slotsToBeClicked2.Uid, 
        // Go to FM1-P1 of Tuesday
        newState6.TimetableListState.ShowingAlternateSlotOf
            ? newState6.TimetableListState.ShowingAlternateSlotOf.AlternativeSlots
                .filter((x) => x.slot.Group[0] === "1")[0].slot.Uid
            : -1));
