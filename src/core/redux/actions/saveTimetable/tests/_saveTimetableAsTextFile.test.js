...
describe("findSisterSlots", () => {
    it("case 1", () => {
        const allSlots = heng_2017_apr_1.HENG_2017_APR();
        const slotsOfCurrentTimetable = [
            // Fluid Mechanics I
        ...
        const result = saveTimetableAsTextFile_1.findSisterSlots(slotsOfCurrentTimetable, allSlots);
        ...
        chai_1.expect(result).to.deep.eq(expectedOutput);
    });
});
