...
class ToggleSetTimeConstraintView extends masterState_1.MasterStateAction {
    ...
    GenerateNewState(state) {
        return Object.assign({}, state, { TimetableListState: Object.assign({}, state.TimetableListState, { ShowingAlternateSlotOf: null }), SetTimeConstraintState: Object.assign({}, state.SetTimeConstraintState, { IsOpen: this.open }) });
    }
}
