...
const mapDispatchToProps = (dispatch) => {
    ...
    return {
        ...
        handleGoToThisAlternateSlot: (sourceSlotUid, destinationSlotUid) => triggerfulDispatch(new goToThisAlternativeSlot_1.GoToThisAlternativeSlot(sourceSlotUid, destinationSlotUid)),
