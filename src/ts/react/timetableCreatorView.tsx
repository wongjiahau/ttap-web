...
interface ITimetableCreatorViewProps
  extends ITimetableCreatorViewStateProps,
    ITimetableCreatorViewDispatchProps {}

export class TimetableCreatorView extends React.Component<
  ITimetableCreatorViewProps,
  {
...
> {
        ...
        <Dialog open={this.state.isDccDialogOpen}>
          ...
          <DialogContent>
            <DialogContentText>
              ...
              <b>invalid</b> timetables.
              <br />
              <br />
              You should only turn on this feature if you want to to visualize
              clashes between different subjects.
              <br />
              <br />
          ...
          <DialogActions>
            <Button
              onClick={() => this.setState({ isDccDialogOpen: false })}
              color="primary"
            >
              cancel
            </Button>
  ...
  private handleToggleDisableClashChecking = (
    event: object,
    checked: boolean
  ) => {
    if (checked) {
