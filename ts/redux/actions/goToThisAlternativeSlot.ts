...
export class GoToThisAlternativeSlot extends MasterStateAction {
  ...
  public TypeName(): string {
    return `go to this alternate slot (destination=${this.destinationSlotUid}) `;
  }
  ...
  protected GenerateNewState(state: IMasterState): IMasterState {
    ...
    const alternativeSlot = sourceSlot.AlternativeSlots.find(
      (slot) => slot.slot.Uid === this.destinationSlotUid
    );
