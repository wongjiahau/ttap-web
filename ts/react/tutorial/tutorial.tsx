...
export class Tutorial extends React.Component<{}, ITutorialState> {
  ...
  public render() {
    ...
    return (
      <div style={{ display: "grid" }}>
        ...
        <Button style={skipButtonStyle} onClick={this.handleSkip}>
          Skip tutorial
        </Button>
      </div>
    );
  ...
  private requestTutorialFiles(): void {
    fetch(
      "https://api.github.com/repos/wongjiahau/ttap-web/contents/tutorials",
      {
        headers: {
          "User-Agent": "hou32hou",
        },
