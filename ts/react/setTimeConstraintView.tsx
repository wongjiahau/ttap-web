        ...
        return (
                ...
                {/* transition={Transition}> */}
                    <DialogContent style={divStyle}>
                        <div style={{display: 'grid', gridTemplate: 'auto auto / auto auto', width: '90%', justifySelf: 'center'}}>
                            <Typography
                                variant="title"
                                style={typo1Style}
                                gutterBottom={true}
                            ...
                            <div style={{display: 'grid', gridGap: '12px', gridTemplateColumns: 'auto auto',
                                ...
                                <Legend type="green" label="Click this if you don't want to have class here"/>
                            </div>
                            <div style={{textAlign: 'left', display: 'grid', gridGap: '4px'}}>
                                ...
                                <Typography variant='caption'>
                                    2. It might be quite difficult for you to pick a favourite timetable out of them.
                                </Typography>
                                <Typography variant='caption'>
                                    3. To overcome this problem, you can use this feature to greatly decrease the number of generated timetables.
                                </Typography>
                                <Typography variant='caption'>
                                    4. To do so, click on the green boxes shown below.
                                </Typography>
                                <Typography variant='caption'>
                                    5. Click as many as you can and make the green bar as long as possible!
                                </Typography>
                            </div>
                        </div>
                        <TimetableView
...
const Report = (props: {
    ...
    return (
    <div style={style}>
        <div style={{...barStyle, background: 'indianred', width: `${props.numberOfRemainingTimetables / total * 100}%`, justifySelf: 'end'}}/>
        ...
        <div style={{...barStyle, background: 'greenyellow', width: `${props.numberOfRemovedTimetables / total * 100}%`}}/>
    </div>
); };
