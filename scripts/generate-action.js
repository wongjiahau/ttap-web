...
const testSnippet = `import {expect} from "chai";
const isEqual = require("lodash.isequal");
import {${actionName}} from "./../actions/${actionFileName}";
import {${stateName}, ${stateName.slice(1)}Reducer, ${stateName.slice(
  1
)}} from "./../reducers/${stateFileName}";
