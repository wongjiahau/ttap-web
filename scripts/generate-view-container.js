...
import {I${viewName}DispatchProps, I${viewName}StateProps, ${viewName}} from "../../react/${decapitalized(viewName)}";
...
const containerFileName = `${__dirname}/../ts/redux/containers/${decapitalized(viewName)}Container.ts`
